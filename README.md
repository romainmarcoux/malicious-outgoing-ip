...
# Statistics
Update of the following table: 2025-07-27 04:19 CEST

| Malicious IP addresses in full-outgoing-ip-a-\*                          | %       | Number of IPs |
| ---------------------------------------------------------- | ------- | ------------- |
| Present in 3 sources and more | 0.64 % | 681 |
| Present in 2 sources | 7.04 % | 7 408 |
| Present in 1 source | 92.31 % | 97 127 |
| Total | 100 % | 105 216 |
