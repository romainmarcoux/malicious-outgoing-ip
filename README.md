...
# Statistics
Update of the following table: 2025-09-13 20:21 CEST

| Malicious IP addresses in full-outgoing-ip-a-\*                          | %       | Number of IPs |
| ---------------------------------------------------------- | ------- | ------------- |
| Present in 3 sources and more | 0.37 % | 741 |
| Present in 2 sources | 6.03 % | 12 016 |
| Present in 1 source | 93.59 % | 186 417 |
| Total | 100 % | 199 174 |
