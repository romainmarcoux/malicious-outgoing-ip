...
# Statistics
Update of the following table: 2025-08-02 23:19 CEST

| Malicious IP addresses in full-outgoing-ip-a-\*                          | %       | Number of IPs |
| ---------------------------------------------------------- | ------- | ------------- |
| Present in 3 sources and more | 0.66 % | 701 |
| Present in 2 sources | 6.92 % | 7 289 |
| Present in 1 source | 92.40 % | 97 225 |
| Total | 100 % | 105 215 |
