...
# Statistics
Update of the following table: 2025-11-30 19:21 CEST

| Malicious IP addresses in full-outgoing-ip-a-\*                          | %       | Number of IPs |
| ---------------------------------------------------------- | ------- | ------------- |
| Present in 3 sources and more | 0.46 % | 669 |
| Present in 2 sources | 8.33 % | 12 118 |
| Present in 1 source | 91.20 % | 132 542 |
| Total | 100 % | 145 329 |
