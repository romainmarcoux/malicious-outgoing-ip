...
# Statistics
Update of the following table: 2025-07-20 00:19 CEST

| Malicious IP addresses in full-outgoing-ip-a-\*                          | %       | Number of IPs |
| ---------------------------------------------------------- | ------- | ------------- |
| Present in 3 sources and more | 0.65 % | 682 |
| Present in 2 sources | 7.11 % | 7 405 |
| Present in 1 source | 92.23 % | 96 041 |
| Total | 100 % | 104 128 |
