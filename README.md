...
# Statistics
Update of the following table: 2024-12-10 07:14 CEST

| Malicious IP addresses in full-outgoing-ip-a-\*                          | %       | Number of IPs |
| ---------------------------------------------------------- | ------- | ------------- |
| Present in 3 sources and more | 1.45 % | 2 155 |
| Present in 2 sources | 10.40 % | 15 372 |
| Present in 1 source | 88.13 % | 130 178 |
| Total | 100 % | 147 705 |
