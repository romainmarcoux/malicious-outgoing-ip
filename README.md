...
# Statistics
Update of the following table: 2024-12-21 21:14 CEST

| Malicious IP addresses in full-outgoing-ip-a-\*                          | %       | Number of IPs |
| ---------------------------------------------------------- | ------- | ------------- |
| Present in 3 sources and more | 0.85 % | 1 302 |
| Present in 2 sources | 9.10 % | 13 813 |
| Present in 1 source | 90.03 % | 136 642 |
| Total | 100 % | 151 757 |
