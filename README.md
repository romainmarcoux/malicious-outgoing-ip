...
# Statistics
Update of the following table: 2024-12-11 05:14 CEST

| Malicious IP addresses in full-outgoing-ip-a-\*                          | %       | Number of IPs |
| ---------------------------------------------------------- | ------- | ------------- |
| Present in 3 sources and more | 1.51 % | 2 245 |
| Present in 2 sources | 10.37 % | 15 365 |
| Present in 1 source | 88.10 % | 130 465 |
| Total | 100 % | 148 075 |
