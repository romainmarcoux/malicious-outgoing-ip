...
# Statistics
Update of the following table: 2025-08-26 03:19 CEST

| Malicious IP addresses in full-outgoing-ip-a-\*                          | %       | Number of IPs |
| ---------------------------------------------------------- | ------- | ------------- |
| Present in 3 sources and more | 0.76 % | 881 |
| Present in 2 sources | 9.51 % | 10 963 |
| Present in 1 source | 89.72 % | 103 397 |
| Total | 100 % | 115 241 |
