...
# Statistics
Update of the following table: 2025-06-16 06:19 CEST

| Malicious IP addresses in full-outgoing-ip-a-\*                          | %       | Number of IPs |
| ---------------------------------------------------------- | ------- | ------------- |
| Present in 3 sources and more | 0.68 % | 694 |
| Present in 2 sources | 6.46 % | 6 573 |
| Present in 1 source | 92.85 % | 94 459 |
| Total | 100 % | 101 726 |
