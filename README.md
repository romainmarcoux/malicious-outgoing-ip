...
# Statistics
Update of the following table: 2025-03-10 23:15 CEST

| Malicious IP addresses in full-outgoing-ip-a-\*                          | %       | Number of IPs |
| ---------------------------------------------------------- | ------- | ------------- |
| Present in 3 sources and more | 0.60 % | 783 |
| Present in 2 sources | 6.21 % | 8 073 |
| Present in 1 source | 93.18 % | 121 124 |
| Total | 100 % | 129 980 |
