...
# Statistics
Update of the following table: 2025-06-08 01:14 CEST

| Malicious IP addresses in full-outgoing-ip-a-\*                          | %       | Number of IPs |
| ---------------------------------------------------------- | ------- | ------------- |
| Present in 3 sources and more | 0.65 % | 681 |
| Present in 2 sources | 6.28 % | 6 558 |
| Present in 1 source | 93.06 % | 97 173 |
| Total | 100 % | 104 412 |
