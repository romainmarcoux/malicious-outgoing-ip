...
# Statistics
Update of the following table: 2025-03-01 21:15 CEST

| Malicious IP addresses in full-outgoing-ip-a-\*                          | %       | Number of IPs |
| ---------------------------------------------------------- | ------- | ------------- |
| Present in 3 sources and more | 0.55 % | 724 |
| Present in 2 sources | 6.68 % | 8 739 |
| Present in 1 source | 92.76 % | 121 316 |
| Total | 100 % | 130 779 |
