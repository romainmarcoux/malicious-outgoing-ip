...
# Statistics
Update of the following table: 2025-03-15 22:15 CEST

| Malicious IP addresses in full-outgoing-ip-a-\*                          | %       | Number of IPs |
| ---------------------------------------------------------- | ------- | ------------- |
| Present in 3 sources and more | 0.42 % | 543 |
| Present in 2 sources | 6.47 % | 8 350 |
| Present in 1 source | 93.10 % | 120 016 |
| Total | 100 % | 128 909 |
