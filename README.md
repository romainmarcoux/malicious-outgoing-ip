...
# Statistics
Update of the following table: 2025-09-27 22:21 CEST

| Malicious IP addresses in full-outgoing-ip-a-\*                          | %       | Number of IPs |
| ---------------------------------------------------------- | ------- | ------------- |
| Present in 3 sources and more | 0.51 % | 650 |
| Present in 2 sources | 9.53 % | 12 059 |
| Present in 1 source | 89.95 % | 113 788 |
| Total | 100 % | 126 497 |
