...
# Statistics
Update of the following table: 2025-03-08 23:15 CEST

| Malicious IP addresses in full-outgoing-ip-a-\*                          | %       | Number of IPs |
| ---------------------------------------------------------- | ------- | ------------- |
| Present in 3 sources and more | 0.45 % | 594 |
| Present in 2 sources | 6.55 % | 8 521 |
| Present in 1 source | 92.99 % | 120 916 |
| Total | 100 % | 130 031 |
