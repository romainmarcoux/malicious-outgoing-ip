...
# Statistics
Update of the following table: 2026-02-01 15:31 CEST

| Malicious IP addresses in full-outgoing-ip-a-\*                          | %       | Number of IPs |
| ---------------------------------------------------------- | ------- | ------------- |
| Present in 3 sources and more | 0.83 % | 1 385 |
| Present in 2 sources | 9.12 % | 15 190 |
| Present in 1 source | 90.04 % | 149 849 |
| Total | 100 % | 166 424 |
