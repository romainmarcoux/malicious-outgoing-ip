...
# Statistics
Update of the following table: 2025-03-03 23:15 CEST

| Malicious IP addresses in full-outgoing-ip-a-\*                          | %       | Number of IPs |
| ---------------------------------------------------------- | ------- | ------------- |
| Present in 3 sources and more | 0.60 % | 790 |
| Present in 2 sources | 6.30 % | 8 242 |
| Present in 1 source | 93.08 % | 121 634 |
| Total | 100 % | 130 666 |
