...
# Statistics
Update of the following table: 2025-09-20 21:21 CEST

| Malicious IP addresses in full-outgoing-ip-a-\*                          | %       | Number of IPs |
| ---------------------------------------------------------- | ------- | ------------- |
| Present in 3 sources and more | 0.55 % | 695 |
| Present in 2 sources | 9.81 % | 12 196 |
| Present in 1 source | 89.62 % | 111 338 |
| Total | 100 % | 124 229 |
