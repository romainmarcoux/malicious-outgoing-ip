...
# Statistics
Update of the following table: 2025-05-11 02:14 CEST

| Malicious IP addresses in full-outgoing-ip-a-\*                          | %       | Number of IPs |
| ---------------------------------------------------------- | ------- | ------------- |
| Present in 3 sources and more | 0.64 % | 761 |
| Present in 2 sources | 6.26 % | 7 394 |
| Present in 1 source | 93.08 % | 109 772 |
| Total | 100 % | 117 927 |
