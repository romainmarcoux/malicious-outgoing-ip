...
# Statistics
Update of the following table: 2025-10-11 23:22 CEST

| Malicious IP addresses in full-outgoing-ip-a-\*                          | %       | Number of IPs |
| ---------------------------------------------------------- | ------- | ------------- |
| Present in 3 sources and more | 0.48 % | 630 |
| Present in 2 sources | 9.89 % | 12 877 |
| Present in 1 source | 89.62 % | 116 635 |
| Total | 100 % | 130 142 |
