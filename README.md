...
# Statistics
Update of the following table: 2025-03-22 20:15 CEST

| Malicious IP addresses in full-outgoing-ip-a-\*                          | %       | Number of IPs |
| ---------------------------------------------------------- | ------- | ------------- |
| Present in 3 sources and more | 0.45 % | 591 |
| Present in 2 sources | 6.30 % | 8 128 |
| Present in 1 source | 93.23 % | 120 228 |
| Total | 100 % | 128 947 |
